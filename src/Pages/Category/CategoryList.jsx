...
const CategoryList = () => {
    const { isOpenFullScreenPanel, setIsOpenFullScreenPanel, cateData, setCateData } = useContext(MyContext)
            ...
            <div className="">
                ...
                <div className="card my- shadow-md sm:rounded-lg bg-white">
                    <div className="flex items-center px-5 py-4 ">
                        <h3 className="text-[20px] font-[700]">Category List {cateData?.length}</h3>
                        <div className="col ml-auto w-[30%] flex items-center gap-2 justify-end ">
                            ...
                            <Button onClick={() => setIsOpenFullScreenPanel({ open: true, model: 'Add Category' })} className="btn-blue btn-sm !font-[600]">Add Categoy</Button>
                        </div>
                    </div>
                                            ...
                                            <td className="px-3 py-2">
                                                <div className="flex items-center gap-2">
                                                    <Tooltip title="Edit" placement="top">
                                                        <Button className="!w-[35px] !h-[35px] !min-w-[35px]"><AiOutlineEdit className="text-[rgba(0,0,0,0.7)] text-[22px]" onClick={() => setIsOpenFullScreenPanel({ open: true, model: 'Edit Category', id: item?._id })} /></Button>
                                                    </Tooltip>
                                                    <Tooltip title="Delete" placement="top">
                                                        <Button onClick={() => deleteCat(item?._id)} className="!w-[35px] !h-[35px] !min-w-[35px]"><MdDeleteOutline className="text-[#8b1c1c] text-[22px]" /></Button></Tooltip>
                                                </div>
                                            </td>
                                        </tr>
                                    })
