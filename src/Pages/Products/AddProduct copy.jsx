...
const AddProduct = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formFields.whatsApp.startsWith("88") || formFields.whatsApp === "") {
            ...
            <form className='form py-3 p-8 ' onSubmit={handleSubmit}>
                <div className='max-h-[75vh] overflow-y-scroll pr-2 mb-3'>
                    <div className="grid grid-cols-1 mb-3">
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-1">Title<span className='text-red-600'> *</span></h3>
                    ...
                    <div className="grid grid-cols-1 mb-3">
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-1">Description <span className='text-red-600'> *</span></h3>
                    ...
                    <div className="grid grid-cols-4 mb-3 gap-3">
                        {/* Category */}
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-2">Category <span className='text-red-600'> *</span></h3>
                            {
                        ...
                        {/* Price */}
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-2">Price <span className='text-red-600'> *</span></h3>
                    ...
                    <div className="grid grid-cols-4 mb-3 gap-3">
                        ...
                        <div className="col">
                            ...
                            >
                                <MenuItem value={200}>50 gm to 200 gm</MenuItem>
                                <MenuItem value={500}>201 gm to 500 gm</MenuItem>
                                <MenuItem value={1000}>501 gm to 1kg</MenuItem>
                                <MenuItem value={2000}>over 1kg to 2kg</MenuItem>
                                <MenuItem value={3000}>over 2kg</MenuItem>
                            </Select>
                        </div>
                        {/* Size */}
                        <div className="col">
                    ...
                    <div className="grid grid-cols-4 mb-3 gap-3">
                        ...
                        {/* Whatsapp */}
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-2">WhatsApp Num <span className='text-red-600'> *</span></h3>
                            <input
                                type="number"
                    ...
                    <div className="grid grid-cols-4 mb-3 gap-3">
                        {/* Rating */}
                        <div className="col">
                            <h3 className="text-[14px] font-[500] mb-2">Rating <span className='text-red-600'> *</span></h3>
