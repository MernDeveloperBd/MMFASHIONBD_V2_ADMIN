...
const SubCategoryList = () => {
    ...
    const { setIsOpenFullScreenPanel,cateData, setCateData , isOpenFullScreenPanel} = useContext(MyContext)
    ...
    },[setCateData, isOpenFullScreenPanel])
            ...
            <div className="">
                ...
                <div className="card my- shadow-md sm:rounded-lg bg-white">
                    <div className="flex items-center px-5 py-4 ">
                        <h3 className="text-[20px] font-[700]">Sub Category List {cateData?.length}</h3>
